...
const player={name:"Aventurero",rank:"NOVATO",level:1,exp:0,crystals:0,gold:0,xpNext:100,act1Completed:0,act1Total:2,mission1Completed:false,mission1Step:0,...(JSON.parse(localStorage.getItem(KEY)||"{}")||{})};
...
function complete(){
 if(!player.mission1Completed){player.mission1Completed=true;player.act1Completed=Math.max(Number(player.act1Completed||0),1);player.mission1Step=steps.length-1;player.exp=Number(player.exp||0)+50;save();hud();toast("+50 EXP · Misión 1 completada");}
